...
namespace SuperSocket.WebSocket
{
        ...
        where TWebSocketSession : WebSocketSession<TWebSocketSession>, new()
    {
        ...
        /// Gets the host.
        /// </summary>
        public string Host { get { return Items.GetValue(WebSocketConstant.Host, string.Empty); } }
        ...
        /// Gets the upgrade.
        /// </summary>
        public string Upgrade { get { return Items.GetValue(WebSocketConstant.Upgrade, string.Empty); } }

        /// <summary>
        /// Gets the connection.
        /// </summary>
        public string Connection { get { return Items.GetValue(WebSocketConstant.Connection, string.Empty); } }

        /// <summary>
        /// Gets the sec web socket version.
        /// </summary>
        public string SecWebSocketVersion { get { return Items.GetValue(WebSocketConstant.SecWebSocketVersion, string.Empty); } }

        /// <summary>
        /// Gets the sec web socket protocol.
        /// </summary>
        public string SecWebSocketProtocol { get { return Items.GetValue(WebSocketConstant.SecWebSocketProtocol, string.Empty); } }
        ...
        {
            string cookieValue = Items.GetValue(WebSocketConstant.Cookie, string.Empty);
